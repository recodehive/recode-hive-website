...
```bash
git clone https://github.com/<your-github-username>/recode-hive-website
```
...
```bash
git remote add upstream https://github.com/original-owner-username/recode-hive-website
```
